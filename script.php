<?php
/**
* Finder PhocagalleryFields Plugin  - Joomla 4.x Module 
* Version			: 2.0.0
...
class plgfinderphocagalleryfieldsInstallerScript
{
	private $min_joomla_version      = '4.0.0';
	private $min_php_version         = '7.4';
	private $name                    = 'Plugin Finder PhocaGalleryFields';
	private $exttype                 = 'plugin';
	private $extname                 = 'phocagalleryfields';
	private $previous_version        = '';
	private $dir           = null;
	private $lang;
	private $installerName = 'plgfinderphocagalleryfieldsinstaller';
	...
	private function postinstall_cleanup() {
		$obsloteFiles = ["phocagalleryfields.php"];
